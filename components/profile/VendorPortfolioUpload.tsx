...
export function VendorPortfolioUpload({ initialMedia }: VendorPortfolioUploadProps) {
  ...
  return (
    <div className="space-y-4">
      <FirebaseUpload 
        ...
        existingMedia={media}
        maxFiles={10} 
        storageFolder="vendors"
      />
      <div className="flex justify-end pt-2">
        <Button 
          onClick={handleSave} 
          disabled={loading}
          className="bg-navy-900 text-gold-500 hover:bg-navy-950"
        >
